...
const pages = [
  ...
  {
    path: "pages/function_doc/function_doc",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/detection_doc/detection_doc",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/communicate_doc/communicate_doc",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/update_info/update_info",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
